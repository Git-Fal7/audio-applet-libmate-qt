...
#groups=('ukui')
depends=('gsettings-qt' 'kwindowsystem' 'libmatemixer' 'libqtxdg' 'mate-desktop' 'qt5-multimedia' 'qt5-svg' 'libcanberra')
makedepends=('autoconf-archive' 'intltool' 'qt5-tools')
